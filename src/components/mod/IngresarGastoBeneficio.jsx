...
const IngresarGastoBeneficio = ({
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      const response = await fetch(`${URL}costoproduccion/ingresar`, {
        method: "POST",
        headers: {
                ...
                <div className="itemProv">
                  <div className="entrada">
                    <input
                      ...
                      type="number"
                      id="beneficio"
                      placeholder="Gastos del beneficio"
                    />
                  </div>
                  {errors.beneficio && (
                    <p className="error">{errors.beneficio.message}</p>
                  )}
                </div>
...
export default IngresarGastoBeneficio;
