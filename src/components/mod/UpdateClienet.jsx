...
const UpdateCliente = ({
  ...
  const [clienteUP, setClienteUP] = useState({
    codigo: "",
    nombre: "",
    telefono: "",
    email: "",
  ...
  useEffect(() => {
    if (id) {
      const getDataUp = async (codigo) => {
        setLoading(true);
        try {
          const response = await fetch(`${URL}clientes/cliente/${codigo}`, {
            headers: {
          ...
          setClienteUP({
            codigo: resCliente.id,
            nombre: resCliente.nombre,
            telefono: resCliente.telefono,
            email: resCliente.email,
            dpi: resCliente.dpi,
            fecha: resCliente.fecha,
          });
        } catch (err) {
          console.error(err);
        }
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`${URL}clientes/actualizar/${id}`, {
        method: "PUT",
